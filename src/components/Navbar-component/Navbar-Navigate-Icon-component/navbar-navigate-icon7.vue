<template>
  <div
    class="navbar-navigate-icon-container-1"
    :style="{ backgroundColor: `${bgColor1}` }"
  >
    <div class="navbar-navigate-icon-mood">
      <div
        @click="handleAppMood('light')"
        class="nav-navigate-icon-sunlight"
