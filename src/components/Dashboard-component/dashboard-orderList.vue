<template>
  <div class="dashboard-orderList-divSection">
    <section
      class="dashboard-orderList-wrapper"
    ...
    >
      ...
      <section class="dashboard-orderList-table">
        <header class="dashboard-orderList-table-header">
          <p :style="{ color: `${headerTagColor}` }" class="table-header-first">
            Name
          </p>
          <p
          ...
          <p :style="{ color: `${headerTagColor}` }" class="table-header-third">
            Amount
          </p>
          <p
            :style="{ color: `${headerTagColor}` }"
          ...
          <p :style="{ color: `${headerTagColor}` }" class="table-header-fifth">
            Invoice
          </p>
        </header>
