<template>
  <section class="dashboard-orderList-wrapper" :style="{ backgroundColor: `${bgColor}`, borderColor: `${bdColor}` }">
    ...
    <section class="dashboard-orderList-table">
      <header class="dashboard-orderList-table-header">
        <p :style="{color: `${headerTagColor}`}" class="table-header-first">Name</p>
        <p :style="{color: `${headerTagColor}`}" class="table-header-second">Date</p>
        <p :style="{color: `${headerTagColor}`}" class="table-header-third">Amount</p>
        <p :style="{color: `${headerTagColor}`}" class="table-header-fourth">Status</p>
        <p :style="{color: `${headerTagColor}`}" class="table-header-fifth">Invoice</p>
      </header>
      <ul class="dashboard-orderList-table-list">
        ...
        >
          <div class="list-item-first">
            <img :style="{borderColor: `${imgBdColor}`}" :src="item.img" alt="avatar" />
            <p :style="{color: `${orderNameColor}`}">{{ item.name }}</p>
          </div>
          <p class="list-item-second">{{ item.date }}</p>
          <p :style="{color: `${orderAmountColor}`}" class="list-item-third">${{ item.amount }}</p>
          <p class="list-item-fourth" ref="statusItem">{{ item.status }}</p>
          <div class="list-item-fifth">
            <svg
            ...
            <p :style="{color: `${viewTagColor}`}">View</p>
          </div>
        </li>
      </ul>
    </section>
